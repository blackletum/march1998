	...
	case MONSTERSTATE_ALERT:
		{
			...
			{
/*				//magic nipples - barney & scientist need to not face the player when idleing. this should insure that.
				int myClass = Classify();

				if (myClass == CLASS_PLAYER_ALLY ||
					myClass == CLASS_HUMAN_PASSIVE)
				{
					...
					{
						//ALERT(at_console, "CUSTOM AI: DONT FACE THE PLAYER\n");
