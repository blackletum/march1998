...
#define	CLASS_BARNACLE			14 // special because no one pays attention to it, and it eats a wide cross-section of creatures.
...
public:
	...
	virtual void SpawnBlood(Vector vecSpot, int bloodColor, float flDamage);
...
#define PARALYZE_DURATION	50		// number of 2 second intervals to take damage
#define PARALYZE_DAMAGE		1.0		// damage to take each 2 second interval

#define NERVEGAS_DURATION	50
#define NERVEGAS_DAMAGE		5.0

#define POISON_DURATION		50
#define POISON_DAMAGE		2.0

#define RADIATION_DURATION	50
#define RADIATION_DAMAGE	1.0

#define ACID_DURATION		50
