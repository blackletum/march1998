...
int CBaseMonster::IRelationship ( CBaseEntity *pTarget )
{
	...
	{			 //   NONE	 MACH	 PLYR	 HPASS	 HMIL	 AMIL	 APASS	 AMONST	APREY	 APRED	 INSECT	PLRALY	PBWPN	ABWPN	BRNCL
	...
	/*HUMANPASSIVE*/{ R_NO	,R_NO	,R_AL	,R_AL	,R_HT	,R_HT	,R_HT	,R_HT	,R_HT	,R_HT	,R_NO	,R_AL,	R_NO,	R_NO,	R_NO	},
	...
	/*ALIENPREDATO*/{ R_NO	,R_NO	,R_DL	,R_DL	,R_DL	,R_NO	,R_HT	,R_NO	,R_HT	,R_DL	,R_NO	,R_DL,	R_NO,	R_NO,	R_NO	},
	...
	/*PBIOWEAPON*/	{ R_NO	,R_NO	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_DL,	R_NO,	R_DL,	R_NO	},
	/*ABIOWEAPON*/	{ R_NO	,R_NO	,R_DL	,R_DL	,R_DL	,R_AL	,R_NO	,R_DL	,R_DL	,R_NO	,R_NO	,R_DL,	R_DL,	R_NO,	R_NO	},
	/*BARNACLE*/	{ R_NO	,R_NO	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_DL,	R_NO,	R_NO,	R_NO	}
	};
...
float CBaseMonster::ChangeYaw ( int yawSpeed )
{
	...
	if (current != ideal)
	{
		...
		float delta = gpGlobals->time - m_flLastYawTime; //magic nipples - yaw speed fix

		//Clamp delta like the engine does with frametime
		if (delta > 0.25)
			delta = 0.25;

		speed = (float)yawSpeed * delta * 2; //magic nipples - yaw speed fix
	...
	m_flLastYawTime = gpGlobals->time; //magic nipples - yaw speed fix
...
void CBaseMonster :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	...
	case SCRIPT_EVENT_SOUND:			// Play a named wave file
		EMIT_SOUND( edict(), CHAN_BODY, pEvent->options, 1.0, ATTN_IDLE ); //magic nipples - npc step
		break;
