...
// Basic Monster AI functions
	...
	void SUB_StartFadeIn(void);
	void SUB_FadeIn(void);
	void EXPORT CallFadeIn(void) { this->SUB_FadeIn(); }
...
// stuff written for new state machine
	...
	virtual int		StickyGib(void); /*{ return STICKYGIB_NONE; }*/
	virtual BOOL	IsBarnaclePrey(void) { return FALSE; }
	virtual void	FadeMonster( void );	// Called instead of GibMonster() when gibs are disabled
	virtual void	FadeTeleMonster(void);
