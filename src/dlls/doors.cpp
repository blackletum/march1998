...
public:
	...
	BOOL	m_bHealthUsed;	//magic nipples - medi-kit doors
...
TYPEDESCRIPTION	CBaseDoor::m_SaveData[] =
{
	...
	DEFINE_FIELD(CBaseDoor, m_bHealthUsed, FIELD_BOOLEAN), //magic nipples - medi-kit doors
...
void CBaseDoor::Spawn()
{
	...
	m_bHealthUsed = false; //magic nipples - medi-kit doors
