...
{
	DEFINE_FIELD(CEnvWeather, Rain_Distance, FIELD_FLOAT),
	DEFINE_FIELD(CEnvWeather, Rain_Mode, FIELD_INTEGER),
	DEFINE_FIELD(CEnvWeather, fadeTime, FIELD_FLOAT),
	DEFINE_FIELD(CEnvWeather, Rain_Drips, FIELD_INTEGER),
	DEFINE_FIELD(CEnvWeather, Rain_randX, FIELD_FLOAT),
	DEFINE_FIELD(CEnvWeather, Rain_randY, FIELD_FLOAT),
	DEFINE_FIELD(CEnvWeather, Rain_windX, FIELD_FLOAT),
	DEFINE_FIELD(CEnvWeather, Rain_windY, FIELD_FLOAT),
};
...
void CEnvWeather::KeyValue(KeyValueData* pkvd)
{
	...
	else if (FStrEq(pkvd->szKeyName, "m_iDripsPerSecond"))
	{
