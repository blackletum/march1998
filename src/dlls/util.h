...
#define		BLOOD_COLOR_YELLOW	(BYTE)193

#define		BLOOD_COLOR_GREEN	(BYTE)54 //leftover
#define		BLOOD_COLOR_PURPLE	(BYTE)148 //diablo
...
extern float		UTIL_SmoothValue(float startValue, float endValue, float speed); //SMFX
extern float		UTIL_SmoothAngle(float startValue, float endValue, float finalValue, float speed); //SMFX
...
extern void			UTIL_Blood(const Vector& origin, const Vector& direction, int color, int amount);
...
// ammo
#define SF_AMMO_NOFALL		0x0002
#define SF_AMMO_INDRAWER	0x0004
