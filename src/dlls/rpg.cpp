...
void CRpgRocket::Precache(void)
{
	...
	m_iFlame = PRECACHE_MODEL("sprites/explode1.spr");
...
void CRpg::PrimaryAttack()
{
	...
	pRocket->pev->velocity = pRocket->pev->velocity + gpGlobals->v_forward;
