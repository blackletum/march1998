...
void V_CalcNormalRefdef ( struct ref_params_s *pparams )
{
	...
	VectorAdd(pparams->viewangles, gHUD.PunchAngle, pparams->viewangles); //magic nipples - all this to make jittery punch work with smooth punch. yum!
...
int V_FindViewModelByWeaponModel(int weaponindex)
{
	...
	static char * modelmap[][2] =	{
		...
		{ "models/p_9mmAR.mdl",			"models/v_mp5.mdl"			},
