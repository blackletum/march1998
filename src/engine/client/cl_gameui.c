...
static void UI_UpdateUserinfo( void )
{
	...
	//Q_strncpy( player->model, Info_ValueForKey( player->userinfo, "barney_model" ), sizeof( player->model ));
	//Q_strncpy(player->model, Info_ValueForKey(player->userinfo, "sci_model"), sizeof(player->scimodel));
