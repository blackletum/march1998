...
void CL_InitLocal( void )
{
	...
	cl_draw_particles = Cvar_Get( "r_drawparticles", "0.85", FCVAR_CHEAT, "render particles" );
	...
	Cvar_Get( "hud_scale", "1", FCVAR_ARCHIVE|FCVAR_LATCH, "scale hud at current resolution" );
