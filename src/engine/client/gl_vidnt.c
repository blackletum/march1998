...
{ "427 x 240 (wide)",	427,	240,	true	},
{ "800 x 480 (wide)",	800,	480,	true	},
{ "853 x 480 (wide)",	853,	480,	true	},
...
void GL_InitCommands( void )
{
	...
	gammaboost = Cvar_Get("gammaboost", "1", FCVAR_ARCHIVE, "boost palette");
	...
	gl_texture_anisotropy = Cvar_Get( "gl_anisotropy", "1", FCVAR_ARCHIVE, "textures anisotropic filter" ); //8 - magic nipples
	...
	gl_round_down = Cvar_Get( "gl_round_down", "3", FCVAR_RENDERINFO, "round texture sizes to nearest POT value" ); //0 - magic nipples
