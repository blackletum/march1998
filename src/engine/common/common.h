...
#define BIT( n )		(1<<( n ))
#define GAMMA		( 2.0 )	//( 2.2 )		// Valve Software gamma magic nipples - changed this
#define INVGAMMA		( 1.0 / 2.2 )	// back to 1.0
#define TEXGAMMA		( 0.75 )		// compensate dim textures
...
#define XASH_VERSION	"1.0"		// engine current version
