...
void IN_ToggleClientMouse( int newstate, int oldstate )
{
	...
	if (newstate == key_console) //magic nipples - mouse look while in console like old half-life builds.
	{
...
void IN_ActivateMouse( qboolean force )
{
	...
	if (cls.key_dest == key_menu) //magic nipples - FIX: needed to mouse doesn't get stuck in menu after leaving console
		clgame.dllFuncs.IN_DeactivateMouse();
